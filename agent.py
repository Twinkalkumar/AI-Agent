...
TOOL_REGISTRY = {
    ...
    "github_list_repos": {
        ...
        "schema": {
            ...
            "function": {
                ...
                "description": "List GitHub repositories the configured token has access to.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "visibility": {
                            ...
                            "description": "Filter by repo visibility (default 'all').",
                        },
                    },
                },
            },
    ...
    "github_list_files": {
        ...
        "schema": {
            ...
            "function": {
                ...
                "description": "List files and folders at a path inside a GitHub repo.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "repo": {
                            "type": "string",
                            "description": "Repo as 'owner/repo', or just 'repo' if a default owner is configured.",
                        },
                        "path": {
                            "type": "string",
                            "description": "Path inside the repo to list (default: repo root).",
                        },
                    },
                    "required": ["repo"],
                },
    ...
    "github_read_file": {
        ...
        "schema": {
            ...
            "function": {
                ...
                "description": "Read the text content of a specific file in a GitHub repo.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "repo": {
    ...
    "github_write_file": {
        "function": github_write_file,
        "schema": {
            "type": "function",
            "function": {
                "name": "github_write_file",
                "description": (
                    "Create or update a file in a GitHub repo, committing the change directly. "
                    "This immediately modifies the repository — use only when the user has clearly "
                    "asked for a specific file to be changed, and confirm the exact change with them first."
                ),
                "parameters": {
                    "type": "object",
                    "properties": {
                        ...
                        "branch": {
                            "type": "string",
                            "description": "Branch to commit to (default: repo's default branch).",
                        },
                    },
